...
const copy = {
  ...
  en: {
    skip: "Skip to content", menuOpen: "Open menu", navHow: "How it works", navThemes: "Themes", navLearn: "Learn", navSongs: "Songs", navRoadmap: "Roadmap", navDownload: "Download",
    version: "v0.5.x · OPEN-SOURCE PRE-RELEASE", heroLine1: "STEP ON STAGE,", heroLine2: "KEEP THE BEAT.", heroLead: "The rhythm game built for people who genuinely want to learn: precise timing, progressive lessons, and your electronic drum kit at the center of the experience.", heroCta: "See how it works", repoCta: "View the code", factKeyboard: "Cross-platform keyboard", factMidi: "CoreMIDI on macOS", factLessons: "12 playable lessons", heroCaption: "Eight readable kit pieces, one musical timeline.", scroll: "EXPLORE",
    ...
    licenseLabel: "LICENSE", licenseTitle: "Open source, clear terms", licenseBody: "The project's original code is distributed under GPL-3.0-only. A separate commercial-license path is being prepared and remains subject to legal review.", readGpl: "Read GPL-3.0", licenseDetails: "Commercial path details", faqTitle: "Frequently asked questions", faq1q: "Do I need an electronic drum kit?", faq1a: "No. Keyboard input is always available, although a MIDI kit brings the experience closer to the real instrument.", faq2q: "Does MIDI work on every system?", faq2a: "Not yet. The production backend uses CoreMIDI on macOS; Windows and Linux currently support keyboard gameplay.", faq3q: "Are commercial songs included?", faq3a: "No. The repository contains only original rights-clean music and an example for player-owned local content.", faq4q: "Is this already a stable release?", faq4a: "No. The initial publication is source-only: no Unity binary is approved for public distribution yet.", footerTagline: "Open-source rhythm game for electronic drum kits. In active development.", contribute: "Contribute", footerLicense: "GPL-3.0-only · public source, no distributed binaries", footerTrademark: "Independent project; Unity, Apple, macOS, CoreMIDI, and hardware names belong to their respective owners."
  }
};
